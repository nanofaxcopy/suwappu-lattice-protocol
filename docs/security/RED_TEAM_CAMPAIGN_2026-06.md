...
`docs/security/campaigns/SCN-XXX-<slug>/` index stays unified
...
```
docs/security/campaigns/SCN-XXX-<slug>/
...
scenario index in `campaigns/README.md` updated.
...
- [`campaigns/README.md`](campaigns/README.md) — unified SCN-XXX index
