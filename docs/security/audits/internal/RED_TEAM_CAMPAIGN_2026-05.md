...
6. **Evidence collection.** Per-scenario directory at
   `docs/security/audits/threat-intel/SCN-XXX-<slug>/` (README, threat-intel
...
[`../threat-intel/README.md`](../threat-intel/README.md). Each row links to its
...
- **Docs added:** ~100 markdown files across 30 campaign
  directories under `docs/security/audits/threat-intel/`
...
`docs/security/audits/internal/SECURITY_AUDIT_2026-05-15.md` §28 has been updated to
